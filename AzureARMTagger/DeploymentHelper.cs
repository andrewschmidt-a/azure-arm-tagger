...
namespace ARMHelpers
{
    ...
    class DeploymentHelper
    {
        ...
        public DeploymentHelper(string subscriptionId, string clientId, string clientSecret, string resourceGroupName, string deploymentName, string resourceGroupLocation, string tenantId){
        ...
        public async void Run(string pathToTemplateFile, string pathToParameterFile, string pathToTagFile)
        {
            ...
            // Read the tags
            JObject tagFileContents = GetJsonFileContents(pathToTagFile);
            // Add Tags
        ...
        private JObject AddTagsToTemplate(JObject template, JObject tags){
